...
The \sorta{filled} pattern is a solid sheet. It is used as a reference test as well as a data point to show stress properties when no holes are used. It should be noted that not all holes have the same area since hole patterns that do not match the shape of the part will not fit the part perfectly, and some shapes will be \sorta{cut off}. The surface area of each part is the 2D surface area of the flat sheet.
...
\begin{figure}[H]
	...
	\renewcommand{\arraystretch}{1.5} % Default value: 1
		\begin{tabular}{ | c | c | c | c | c | }\hline
			...
			Square Diamond	& 2.545 	& 0.188 			& 129.37	 			& 84		\\\hline
			Hex			& 2.506 	& 0.186 			& 114.55	 			& 94		\\\hline
			Hex Diamond		& 2.497 	& 0.185 			& 155.38	 			& 70		\\\hline
			Triangle		& 2.500 	& 0.185			& 170.65	 			& 64		\\\hline
		\end{tabular}
	\endgroup
	\end{subfigure}
\end{figure}
